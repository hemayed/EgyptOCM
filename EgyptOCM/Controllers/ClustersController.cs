...
namespace EgyptOCM.Controllers
{
    ...
    {
        private EOCMDataEntities db = new EOCMDataEntities();
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ClusterNature_ID = new SelectList(db.ClusterNatures, "ClusterNature_ID", "ClusterNature_Name");
            ViewBag.ClusterType_ID = new SelectList(db.ClusterTypes, "ClusterType_ID", "ClusterType_Name");
            ViewBag.MarketType_ID = new SelectList(db.MarketTypes, "MarketType_ID", "MarketType_Name");
            ViewBag.ProductSeason_ID = new SelectList(db.ProductSeasons, "ProductSeason_ID", "ProductSeason_Name");

            ViewBag.ExportFlag_ID = new SelectList(db.ExportFlags, "ExportFlag_ID", "ExportFlag_Name");
            ViewBag.IncomeLevel_ID = new SelectList(db.IncomeLevels, "IncomeLevel_ID", "IncomeLevel_Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Cluster_Name,Govt_ID,District_ID,Village_ID,Sector_ID,Field_ID,Product_ID,Cluster_Lat,Cluster_Long,Cluster_EmpNumMin,Cluster_EmpFemale,Cluster_ShopNumMin,Cluster_ProductImage,Cluster_ProcessImage,Cluster_DetailPage1,Cluster_DetailPage2,Cluster_DetailPage3,ClusterNature_ID,ClusterType_ID,NonOfficalProjects,OfficalProjects,Products,MoreProducts,Address,Challenges,MoreChallenges,SupportingOrg,Cluster_StudyFile1,Cluster_StudyFile2,CompanyPercent1,CompanyPercent2,CompanyPercent3,CompanyPercent4,MarketType_ID,ProductSeason_ID,ProductSeasonDetail,ExportFlag_ID,ExportVolume,Income,IncomeLevel_ID,AdditionalInfo")] Cluster cluster)
        {
            ...
            ViewBag.ClusterNature_ID = new SelectList(db.ClusterNatures, "ClusterNature_ID", "ClusterNature_Name",cluster.ClusterNature_ID);
            ViewBag.ClusterType_ID = new SelectList(db.ClusterTypes, "ClusterType_ID", "ClusterType_Name",cluster.ClusterNature_ID );
            ViewBag.MarketType_ID = new SelectList(db.MarketTypes, "MarketType_ID", "MarketType_Name",cluster.MarketType_ID);
            ViewBag.ProductSeason_ID = new SelectList(db.ProductSeasons, "ProductSeason_ID", "ProductSeason_Name",cluster.ProductSeason_ID );
            ViewBag.ExportFlag_ID = new SelectList(db.ExportFlags, "ExportFlag_ID", "ExportFlag_Name", cluster.ExportFlag_ID);
            ViewBag.IncomeLevel_ID = new SelectList(db.IncomeLevels, "IncomeLevel_ID", "IncomeLevel_Name", cluster.IncomeLevel_ID);
        ...
        public ActionResult Edit(string id)
        {
            ...
            ViewBag.Village_ID = new SelectList(db.Villages, "Village_ID", "Village_Name", cluster.Village_ID);
            ViewBag.ClusterNature_ID = new SelectList(db.ClusterNatures, "ClusterNature_ID", "ClusterNature_Name", cluster.ClusterNature_ID);
            ViewBag.ClusterType_ID = new SelectList(db.ClusterTypes, "ClusterType_ID", "ClusterType_Name", cluster.ClusterType_ID);
            ViewBag.MarketType_ID = new SelectList(db.MarketTypes, "MarketType_ID", "MarketType_Name", cluster.MarketType_ID);
            ViewBag.ProductSeason_ID = new SelectList(db.ProductSeasons, "ProductSeason_ID", "ProductSeason_Name", cluster.ProductSeason_ID);
            ViewBag.ExportFlag_ID = new SelectList(db.ExportFlags, "ExportFlag_ID", "ExportFlag_Name", cluster.ExportFlag_ID);
            ViewBag.IncomeLevel_ID = new SelectList(db.IncomeLevels, "IncomeLevel_ID", "IncomeLevel_Name", cluster.IncomeLevel_ID);
